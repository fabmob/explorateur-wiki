...
export default function Contact(props) {
  ...
  return (
    ...
    >
      ...
      <p>
        Envoyez un message à <em>contact AROBASE fabmob.io</em>
      </p>
    </Panel>
  );
    ...
    >
      ...
      <Form
        ...
        onSubmit={(e) => {
          ...
          if (!user.nom || !user.email || !user.objet || !user.message) {
            ...
            formData.append(
              "form-name",
              ["integration", "fabmob", "autre"].includes(user.objet)
                ? "contact"
                : "bug"
            );
      ...
      >
        ...
        >
          ...
          <option value="fabmob">
            Je souhaite en savoir plus sur la Fabrique des Mobilités
          </option>
